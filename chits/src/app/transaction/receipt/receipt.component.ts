...
export class ReceiptComponent implements OnInit {
  ...
  searchFilter(routeValue: any, recptype: any, recpdate: any, filterCustomerName: any,  filterBranchName : any) {
    ...
    this.url_value =
      this.userData.getReceipt + '?size=10&page=' + this.pageNumber;
  ...
  getReceiptDetailsbyId(receiptId: any) {
    this.http
      .get(this.userData.getReceiptById + receiptId)
      .subscribe((data) => {
        this.grpidoutput = data;
        Object.keys(this.grpidoutput).forEach((prop) => {
          if (prop == 'object') {
  ...
  updateReceipt(ReceiptModal: any) {
    this.http
      .put(this.userData.updatereceipt, ReceiptModal)
      .subscribe((result) => {
  ...
  deleteReceipt(data: any): void {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        ...
        this.http
          .delete(this.userData.deleteReceiptById + data)
          .subscribe((data) => {
